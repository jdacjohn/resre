                    ...
                    <div class="wt-content-wrapper left">
                        <form method="post" name="rdaBForm" id="rdaBForm" action="<?php echo HOME_LINK; ?>_includes/procCrit/procUS-RDA-B.php">
                            ...
                            <div class="row">  <!-- Step number and page heading -->
                                <div class="col-xs-2 chars-marker chars"><span class="blue2532Bold marker-white" style="margin-bottom: 0px; ">8</span></div>
                                <div class="col-xs-10 topic"><h4 class="chars-h4">Roof Deck Attachment - B</h4></div>
                            </div>
