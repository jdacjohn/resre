...
<!-- Data Saved Modal -->
<div id="dataSavedModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="padding-left: 50px; padding-top: 30px; padding-bottom: 0px; border-bottom: none;">
                ...
                <h6 style="font-weight: 500;"><strong>Selections Saved.</strong></h6>
                <p class="slate2025 modal-p" style="margin-bottom: 0px;">Your most recent selections have been saved.  Your home characteristics will be automatically loaded next time you log in.</p>
