    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="padding-left: 50px; padding-top: 30px; padding-bottom: 0px; border-bottom: none;">
                ...
                <h6 style="font-weight: 500;"><strong>Logout.</strong></h6>
                <p class="slate2025 modal-p" style="margin-bottom: 0px;">You have been logged out.  Thank you for visiting Resilent Residence.</p>
