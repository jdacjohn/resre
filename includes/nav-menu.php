            ...
            <div class="navbar-wrapper">
                ...
                <div class="collapse navbar-collapse" id="bs-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a class="page-scroll <?php echo $navStyle; ?>" href="<?php echo SITE_ROOT . '/'; ?>index.php">Home</a></li>
                        <li><a class="page-scroll <?php echo $navStyle; ?>    " href="<?php echo SITE_ROOT . '/'; ?>#">Help</a></li>
                        <?php
                            if ( isset($_SESSION[SESSION_NAME]['user']['logged_in']) && $_SESSION[SESSION_NAME]['user']['logged_in'] == true) {
                        ?>
                        <li><a class="page-scroll mustard2025Black" href="<?php echo SITE_ROOT . '/'; ?>/login.php?confirm=logout">Logout</a></li>
                            <?php } ?>
                    </ul>
                </div>
